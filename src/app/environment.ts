...
//     private _mode: string  = "dev"
    ...
    constructor (){
        if (this._mode === "dev"){
            ...
            this._inputUrl = 'http://everessttemposynctoolenvironment.eba-qf77mbzt.eu-central-1.elasticbeanstalk.com/input';
            this._syncUrl = 'http://everessttemposynctoolenvironment.eba-qf77mbzt.eu-central-1.elasticbeanstalk.com/sync';
        }
    }
